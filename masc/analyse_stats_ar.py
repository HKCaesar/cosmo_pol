...
f.write('Aggregates: avg: a = '+str(np.exp(fit_mean[1]))+', b = '+str(fit_mean[0])+' \n') # python will convert \n to os.linesep
...
f.write('-------\n')
f.write('Graupel: avg: a = '+str(np.exp(fit_mean[1]))+', b = '+str(fit_mean[0])+' \n') # python will convert \n to os.linesep
