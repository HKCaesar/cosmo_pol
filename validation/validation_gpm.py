...
#        #########
#        # ZH
##        if not os.path.exists('./GPM/Measured/Ku/'+bname+'.npy'):
##            print(bname)
...
#            
        ...
        #########
        # ZH
#        if not os.path.exists('./GPM/Measured/Ka/'+bname+'.npy'):
...
#        
    ...
    s.load_model_file(f_cosmo)
    if os.path.exists(f_cosmo) and not os.path.exists('./GPM/Simulated_PRECIP_2mom/Ku/'+bname+'.npy'):
