...
#        # Get precip
#
#        if os.path.exists('/media/wolfensb/Storage/Dropbox/GPM/PRECIP/COSMO_PRECIP/'+bname.replace('-','')+'.nc'):
#            if not os.path.exists('./GPM/Simulated_PRECIP_1mom/Ku/'+bname+'.npy'):
...
#        # Get precip    
#        if os.path.exists('/media/wolfensb/Storage/Dropbox/GPM/PRECIP/COSMO_PRECIP/'+bname.replace('-','')+'.nc'):
#            if not os.path.exists('./GPM/Simulated_PRECIP_1mom/Ka/'+bname+'.npy'):
#
#                    
#                gpm = h5py.File(f,'r')
...
#                COSMO.close()
    ...
    print(os.path.exists('./GPM/Simulated_PRECIP_2mom/Ku/'+bname+'.npy'))
#    if os.path.exists(f_cosmo) and not os.path.exists('/storage/cosmo_pol/validation/GPM/Simulated_PRECIP_2mom/Ku/'+bname+'.npy'):
    s.load_model_file(f_cosmo)
    # KU band
    #########
    # ZH
