...
##             print 'warning: number of axis values changed'
    ...
    def lookup_pts(self, coords):
        ...
        out = ndimage.map_coordinates(self.value_table, coords,mode='nearest',order=1)
    ...
    def lookup_line(self,**kwargs):
        ...
        for i,k in enumerate(kwargs.keys()):
            ...
            slc[ax_idx]=slice(closest,closest+1)
...
if __name__ == '__main__':
    ...
    list_elevations=range(0,91,2)
    list_temperatures=range(200,314,2)
    list_D=np.linspace(0.2,10,1024).astype('float32')
    list_scatt=np.arange(0,20)
    ...
    lut_rcs.set_value_table(v,map_to_int=False)
#    
#    print lut_rcs.value_table.nbytes
#    
    
#    tic()
#    for i in range(1000):
#        l=lut_rcs.lookup_line(e=10,t=298)
#    toc()
#
#    coords=[]
#    for i in range(1000):
#        coords.append([list_elevations[15],list_temperatures[10],11,3])
